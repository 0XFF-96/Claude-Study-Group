...
- [x] IAM: users, groups, roles, policies (identity vs resource policies)
- [x] IAM best practices: least privilege, MFA, roles over long-lived keys
- [x] AWS Organizations & Service Control Policies (SCPs)
- [x] VPC security: security groups vs network ACLs
- [x] Encryption at rest: KMS, customer vs AWS-managed keys, envelope encryption
- [x] Encryption in transit: TLS, ACM certificates
